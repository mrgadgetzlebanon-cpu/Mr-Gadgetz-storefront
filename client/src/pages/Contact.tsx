...
export default function Contact() {
  return (
    <>
      <SEO
        title="Contact | Mr. Gadgetz"
        description="Get in touch with Mr. Gadgetz. Visit our store, call us, or send us a message. We're here to help with all your electronics needs."
